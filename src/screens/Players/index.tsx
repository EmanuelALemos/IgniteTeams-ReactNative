...
import { playerRemoveByGorup } from "@storage/player/playerRemoveByGroup.";
...
export function Players() {
    ...
    async function fetchPlayersByTeam() {
        try{
            const playersByTeam = playerGetByGroupAndTeam(group, team);
    ...
    async function handlePlayerRemove(playerName: string) {
        try{
            await playerRemoveByGorup(playerName, group);
            fetchPlayersByTeam();
        }catch(error){
            console.log(error);
